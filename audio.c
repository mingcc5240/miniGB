...
//#define AUDIO_SAMPLE_RATE	45056
 ...
 */
void au_c(void *ptr, uint8_t *data, int len);

/**
 * Read audio register at given address "addr".
 */
uint8_t au_r(const uint16_t addr);

/**
 * Write "val" to audio register at given address "addr".
 */
void au_w(const uint16_t addr, const uint8_t val);
 ...
 */
void au_c(void *userdata, uint8_t *stream, int len)
{
